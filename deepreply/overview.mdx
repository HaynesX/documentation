...
<Note>
DeepReply is a premium feature that uses the your [DeepReply Quota](/pro/pricing-and-quotas#free-tier-quotas), as tracking replies made outside the API involves continuous monitoring of X's platform. Any attempts made, whether the reply was found or not, will be deducted from your DeepReply Quota / Add-on Balance.
</Note>
...
4. [Create a DeepReply](/deepreply/generate-deepreplies) by clicking the `[💬]` Button on active raids. This will open a page where you can reply via DeepReply.
